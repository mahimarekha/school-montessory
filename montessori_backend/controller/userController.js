...
const verifyEmailAddress = async (req, res) => {
  ...
  if (isAdded) {
    ...
    const body = {
      ...
      <p>Verify your email address to complete the signup and login into your <strong>CloudKitchen</strong> account.</p>
        ...
        <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@cloudkitchen.com</p>
